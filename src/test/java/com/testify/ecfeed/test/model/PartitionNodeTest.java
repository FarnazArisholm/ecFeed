...
public class PartitionNodeTest extends PartitionNode {
	...
	public void testEquals(){
		...
		//Commeneted 	assertTrue(booleanPartition.equals(booleanPartitionCopy));
		...
		//Commeneted 	assertTrue(bytePartition.equals(bytePartitionCopy));
		...
		//Commeneted assertTrue(charPartition.equals(charPartitionCopy));
		...
		//Commeneted 	assertTrue(intPartition.equals(intPartitionCopy));
		...
		//Commeneted 	assertTrue(longPartition.equals(longPartitionCopy));
		...
		//Commeneted 	assertTrue(shortPartition.equals(shortPartitionCopy));
		...
		//Commeneted assertTrue(floatPartition.equals(floatPartitionCopy));
		...
		//Commeneted assertTrue(doublePartition.equals(doublePartitionCopy));
		...
		//Commeneted assertTrue(stringPartition.equals(stringPartitionCopy));
		...
		//Commeneted 	assertTrue(nullStringPartition.equals(nullStringPartitionCopy));
		...
		//Commeneted 	assertTrue(emptyStringPartition.equals(emptyStringPartitionCopy));
	}
